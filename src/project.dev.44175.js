window.__require = function e(t, n, r) {
  ...
  GameScene: [ function(require, module, exports) {
    ...
    var GameScene = function(_super) {
      ...
      GameScene.prototype.startGame = function() {
        ...
        var origPokers = Pokers_1.Pokers.concat();
        var solutionPokers = [];
        var group1 = [];
      ...
      GameScene.prototype.recyclePoker = function() {
        ...
        var i = 0;
        var isAction = false;
        this.PokerFlipRoot.childrenCount >= 3 ? this.FlipAnimation.play() : isAction = true;
      ...
      GameScene.prototype.onPokerFlipAddChild = function(child) {
        ...
        Game_1.Game.addFlipCounts(0);
        Game_1.Game.isComplete() || this.updateFlipPokerPosOnAdd();
      };
      GameScene.prototype.onPokerFlipRemoveChild = function(child) {
        ...
        Game_1.Game.addFlipCounts(0);
        Game_1.Game.isComplete() || this.updateFlipPokerPos();
      };
  ...
  Game: [ function(require, module, exports) {
    ...
    var GameMgr = function() {
      ...
      GameMgr.prototype.checkIsRecycleComplete = function() {
        var isComplete = 52 == this.recycleCount;
        if (isComplete) {
      ...
      GameMgr.prototype.addPlacePokerRoot = function(key, node) {
        ...
        this.placePokerRoot.length > 7 && console.error(" place Poker Root over size!!!!!:", this.placePokerRoot.length);
      };
  ...
  Pokers: [ function(require, module, exports) {
    ...
    console.log(exports.PokerTypes);
    console.log("------------------AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA----------------");
    console.log("spade - spade:", CMath.CheckNumberBit(exports.PokerTypes.spade_, exports.PokerTypes.spade_), "spade - club:", CMath.CheckNumberBit(exports.PokerTypes.spade_, exports.PokerTypes.club_), ", spade - diamond:", CMath.CheckNumberBit(exports.PokerTypes.spade_, exports.PokerTypes.diamond_), ",spade - heart:", CMath.CheckNumberBit(exports.PokerTypes.spade_, exports.PokerTypes.heart_));
    console.log("club - club:", CMath.CheckNumberBit(exports.PokerTypes.club_, exports.PokerTypes.club_), ", club - diamond:", CMath.CheckNumberBit(exports.PokerTypes.club_, exports.PokerTypes.diamond_), ",club - heart:", CMath.CheckNumberBit(exports.PokerTypes.club_, exports.PokerTypes.heart_));
    console.log("diamond - diamond:", CMath.CheckNumberBit(exports.PokerTypes.diamond_, exports.PokerTypes.diamond_), ",diamond - heart:", CMath.CheckNumberBit(exports.PokerTypes.diamond_, exports.PokerTypes.heart_));
    console.log("heart - heart:", CMath.CheckNumberBit(exports.PokerTypes.heart_, exports.PokerTypes.heart_));
    console.log("----------------AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA------------------");
  ...
  Poker: [ function(require, module, exports) {
    ...
    var Poker = function(_super) {
      ...
      Poker.prototype.initEvent = function() {
        ...
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.COMPLETE, this.autoComplete, this);
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.AUTO_COMPLETE_DONE, this.autoCompleteDone, this);
      };
      Poker.prototype.autoCompleteDone = function() {
        var _this = this;
        var selfPos = CMath.ConvertToNodeSpaceAR(this.node, Game_1.Game.removeNode);
        this.node.setParent(Game_1.Game.removeNode);
        this.node.setPosition(selfPos);
        this.scheduleOnce(function() {
          var dir = _this.value % 2 == 1 ? 1 : -1;
          _this.canMove = false;
          _this.node.runAction(cc.sequence(cc.delayTime(_this.value / 10 + CMath.getRandom(0, 2)), cc.callFunc(function() {
            _this.node.group = "top";
          }, _this), cc.sequence(cc.repeat(cc.spawn(cc.moveBy(.01, 1.5 * dir, 25).easing(cc.easeQuinticActionOut()), cc.rotateBy(.01, 20 * dir).easing(cc.easeQuadraticActionIn())), 30), cc.repeat(cc.spawn(cc.moveBy(.01, 2 * dir, -25).easing(cc.easeQuinticActionIn()), cc.rotateBy(.01, 20 * dir).easing(cc.easeQuadraticActionIn())), 180), cc.callFunc(function() {
            console.log("done!");
      ...
      Poker.prototype.autoComplete = function() {
        if (this.next) this.isReadyAutoComplete = false; else {
      ...
      Poker.prototype.checkAutoRecycle = function(delay) {
        var _this = this;
        ...
        var index = -1;
        window["CheatOpen"] && true ? index = Poker_1.DebugRecycIndex++ % 4 : Game_1.Game.getCycledPokerRoot().forEach(function(key, node) {
      ...
      Poker.prototype.checkCanRecycled = function() {
        ...
        Game_1.Game.getCycledPokerRoot().forEach(function(key, root) {
          ...
          if (poker && Poker_1.checkRecycled(poker, _this) || !poker && 1 == _this.value) {
            var pos = CMath.ConvertToNodeSpaceAR(root, _this.node.parent);
            Math.abs(pos.x - _this.node.x) <= _this.placeLimit.width && Math.abs(pos.y - _this.node.y) <= _this.placeLimit.height && (index = key);
          }
        });
        return index;
      };
      Poker.prototype.updateRootNode = function(index) {
        console.log("this.node.childrenCount\uff1a", this.node.childrenCount, "name:", this.node.name, "key:", this.key, "value:", this.value, "this.defualtChildCount:", this.defualtChildCount);
        ...
        if (this.node.childrenCount <= this.defualtChildCount) {
          ...
          console.log("this.next:", this.next.getValue(), ",key:" + this.next.getKey());
      ...
      Poker.prototype.placeToNewCycleNode = function(index, delay) {
        ...
        this.node.runAction(cc.sequence(cc.delayTime(delay), cc.moveTo(time, 0, 0), cc.callFunc(function() {
          _this.node.group = "default";
          _this.RecycleAnimation.play();
          !Game_1.Game.checkIsRecycleComplete() && completeFunc && completeFunc();
        }, this)));
      };
      ...
      Poker.prototype.onAddChild = function(child) {
        ...
        if (this.cycled) {
          ...
          var index = Game_1.Game.getCycledPokerRoot().keyOf(this.node);
          null != index && Game_1.Game.addCycledPokerRoot(index, child);
          return;
        }
        poker.setRecycle(false);
      ...
      Poker.prototype.onChildRemove = function(child) {
        ...
        if (this.cycled) {
          ...
          var poker = child.getComponent(Poker_1);
          var index = Game_1.Game.getCycledPokerRoot().keyOf(child);
          null != index && Game_1.Game.addCycledPokerRoot(index, this.node);
          poker && poker.setRecycle(false);
          return;
        }
        if (this.node.childrenCount <= this.defualtChildCount) {
